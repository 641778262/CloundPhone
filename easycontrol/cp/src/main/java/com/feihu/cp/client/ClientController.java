...
//    miniView = new MiniView(device);
        ...
        if (device.lightOffOnConnect)
            handler.postDelayed(() -> handleControll(device.uuid, "buttonLightOff", null), 2000);
    }
    ...
    private static void handleAction(ClientController clientController, String action, ByteBuffer byteBuffer) {
        try {
            ...
            else if (action.equals("buttonWake"))
                clientController.clientStream.writeToMain(ControlPacket.createPowerEvent(1));
            else if (action.equals("buttonLock"))
                clientController.clientStream.writeToMain(ControlPacket.createPowerEvent(0));
            else if (action.equals("buttonLight"))
                clientController.clientStream.writeToMain(ControlPacket.createLightEvent(Display.STATE_ON));
            else if (action.equals("buttonLightOff"))
                clientController.clientStream.writeToMain(ControlPacket.createLightEvent(Display.STATE_UNKNOWN));
            else if (action.equals("buttonBack"))
                clientController.clientStream.writeToMain(ControlPacket.createKeyEvent(4, 0));
            else if (action.equals("buttonHome"))
                clientController.clientStream.writeToMain(ControlPacket.createKeyEvent(3, 0));
            else if (action.equals("buttonSwitch"))
                clientController.clientStream.writeToMain(ControlPacket.createKeyEvent(187, 0));
            else if (action.equals("buttonRotate"))
            ...
            else if (action.equals("writeByteBuffer"))
